...
- テスト用ファームウェア [cannonball_test.hex](https://github.com/Taro-Hayashi/Cannonball/releases/download/14.19/cannonball_test.hex)
...
- [cannonball_via.hex](https://github.com/Taro-Hayashi/Cannonball/releases/download/14.19/cannonball_via.hex)
